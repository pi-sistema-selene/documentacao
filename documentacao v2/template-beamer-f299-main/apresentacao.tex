...
\begin{itemize}
\item \textbf{Problema:} contaminações e deformidades comprometem a produção.

\item \textbf{Impactos:} perdas produtivas e financeiras decorrentes da detecção tardia.

\item \textbf{Público-alvo:} fungicultores que necessitam de monitoramento contínuo.

\item \textbf{Solução:} integração de IA e IoT para identificação precoce.

\item \textbf{Lacuna:} escassez de plataformas integradas para análise do cultivo.
\end{itemize}
...
{\tiny Fluxo do problema identificado}
\end{minipage}
\hfill
\begin{minipage}{0.49\linewidth}
\centering
...
{\tiny Percentual estimado de perdas na produção}
\end{minipage}
...
Monitoring Mushroom Growth With Machine Learning - Moysiadis et al. (2023) &
...
IoT Enabled Mushroom Farm Automation With Machine Learning to Classify Toxic Mushrooms in Bangladesh - Rahman et al. (2022) &
...
Harnessing AI foi Agriculture: Oyster Mushroom Disease Detection With IoT and Web Application on Growing Bags Using Deep Learning - Nuankaew et al. (2025) &
...
\item \textbf{IoT}: ESP32, sensores de umidade, temperatura, luminosidade e ESP32-CAM.
...
{
\setbeamercolor{background canvas}{bg=gray!3}
...
\item \parbox{\linewidth}{\textbf{Demonstração} do aplicativo de monitoramento do cultivo.}

\item \parbox{\linewidth}{Visualização em tempo real dos dados de produção.}

\item \parbox{\linewidth}{Fluxo completo de monitoramento, análise e \textbf{tomada de decisão} do produtor.}

\item \parbox{\linewidth}{Demonstração integrada dos módulos de administrador e produção, incluindo monitoramento, análise de dados e suporte à tomada de decisão.}

\end{itemize}

\end{column}

% Coluna da direita (6 prints)
...
\hspace*{3cm}
\includegraphics[height=0.42\textheight]{imgs/1.jpeg}
\hspace{0.09cm}
\includegraphics[height=0.42\textheight]{imgs/2.jpeg}
\hspace{0.09cm}
\includegraphics[height=0.42\textheight]{imgs/3.jpeg}

\vspace{0.08cm}

\hspace*{3cm}
\includegraphics[height=0.42\textheight]{imgs/4.jpeg}
\hspace{0.09cm}
\includegraphics[height=0.42\textheight]{imgs/5.jpeg}
\hspace{0.09cm}
\includegraphics[height=0.42\textheight]{imgs/6.jpeg}
